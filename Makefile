...
OBJ = paris.o solids.o modules.o vofmodules.o front.o surface_tension.o lppmodules.o st_testing.o
SRC = $(wildcard  *.f90) 
...
paris.o:  paris.f90 solids.o modules.o vofmodules.o front.o surface_tension.o lppmodules.o st_testing.o
	$(FC) -c  $(FFLAGS) $<
