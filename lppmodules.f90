...
! DEBUG
!      write(*,*) '**',xc,yc,zc,ylpp_min,ylpp_max,ConvertDropRegion
!      write(*,*) '##',vol,vol_cut,AspRatio,AspRatioTol,ConvertDropShape,ConvertDropFlag
! END DEBUG
...
! DEBUG
      if ( uf /= uf ) then 
         write(*,*) nStepConverion, iStepConversion, ConvertRegSize/dx(ip),ip,jp,kp,u(ip,jp,kp),uf
      end if ! uf
! END DEBUG
